...
class Propellerads:
    def __init__(self):
        self.cost_list = {}
        self.apikey = "44daf40ab0244cff8a0bb7c51b0117dda81fcfd2"
    ...
    def campaigns(self, table_name):
        ...
        print (url)
        data = {"params[group_by]": "campaign_id", "date_range": "last_year"}
    ...
    def analysis(self):
        # print(id)
        url = config.get('propellerads', 'getCampaigns')
        # print "analysis url", url
        # data = {"quick": "this_year", "campaigns": 4525947, "websites": "desc"}
        data = {"key": self.apikey, "date_range": "last_year", "params[group_by]": "campaign_id"}
        res, respond = HttpSpider().internal_post(url, data, timeout=300)
        if respond:
            data = json.loads(respond.encode())
            print (data)
...
if __name__ == '__main__':
    ...
    propellerads.analysis()
    # popad.play_campaigns()
    # popad.pause_campaigns()
